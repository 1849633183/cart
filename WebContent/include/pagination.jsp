                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-6 col-md-6">
                                                        <ul class="pagination" id="pagination">
                                                         <li id="doubleright" class="page-item"><a href="User_Productslist_list?page.type=${page.type}&page.start=0" class="page-link">|<i class="fa fa-angle-double-left"></i></a></li>
                                                            <li <c:if test="${!page.isHasPreviouse()}">style="display:none"</c:if> id="left" class="page-item"><a href="User_Productslist_list?page.type=${page.type}&page.start=${page.start-page.count}" class="page-link"><i class="fa fa-angle-left"></i></a></li>                                                               
                                                            <li <c:if test="${!page.isHasPreviouse()}">style="display:none"</c:if> id="page" class="page-item"><a href="User_Productslist_list?page.type=${page.type}&page.start=${page.start-page.count}" class="page-link">${page.getPageIndex()-1}</a></li>
