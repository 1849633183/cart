                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="promo-banner hover-effect-1">
                                <a href="#">
                                    <img src="assets/images/banners/banner-4.jpg" alt="Promo Banner">
                                </a>
                            </div>
                        </div> <!-- end of promo-banner -->
                    </div> <!-- end of row -->
                            ...
                            <div class="categories-carousel product-carousel" data-visible-slide="5" data-loop="false" data-speed="1000">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-1.jpg" alt="Category Image"></a>
                                            </div>
                                    ...
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-2.jpg" alt="Category Image"></a>
                                            </div>
                                            <div class="media-content">
                                    ...
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-3.jpg" alt="Category Image"></a>
                                            </div>
                                            <div class="media-content">
                                    ...
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-4.jpg" alt="Category Image"></a>
                                            </div>
                                            <div class="media-content">
                                    ...
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-5.jpg" alt="Category Image"></a>
                                            </div>
                                            <div class="media-content">
                                    ...
                                    <div class="single-category swiper-slide">
                                        <div class="media-wrapper">
                                            <div class="media-image">
                                                <a href="shop-grid.html"><img data-original="assets/images/category/fcat-6.jpg" alt="Category Image"></a>
                                            </div>
                                            <div class="media-content">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            ...
                            <ul class="nav nav-pills mb-5 justify-content-center" id="best_products" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="nav_gamepad" data-toggle="pill" href="#category_gamepad" role="tab" aria-controls="category_gamepad" aria-selected="true">Gamepad</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="nav_smartwatch" data-toggle="pill" href="#category_smartwatch" role="tab" aria-controls="category_smartwatch" aria-selected="false">SmartWatch</a>
                                </li>
                                <li class="nav-item">
                                                    ...
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            ...
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-1-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-1-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            ...
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-2-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-2-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            ...
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-3-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-3-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            ...
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-4-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-4-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                            ...
                                            <div class="swiper-slide product-layout product-grid">
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            <a href="#">
                                                                <img data-original="assets/images/products/best/products-5-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-5-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                            ...
                                            <div class="swiper-slide product-layout product-grid">
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            <a href="#">
                                                                <img data-original="assets/images/products/best/products-6-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-6-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            <div class="label-product label-new">New</div>
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-7-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-7-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            <div class="label-product label-new">New</div>
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-8-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-8-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            <div class="label-product label-new">New</div>
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-9-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                ...
                                                <div class="product-thumb">
                                                    <div class="product-inner">
                                                        <div class="product-image">
                                                            ...
                                                            <a href="single-product.html">
                                                                <img data-original="assets/images/products/best/products-10-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                <img data-original="assets/images/products/best/products-10-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                            </a>
                                                            <div class="action-links">
                                                                <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                                <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner with-bottom-padding">
                                                <div class="product-image">
                                                    <div class="label-product label-sale">-64%</div>
                                                    <a href="single-product.html">
                                                        <img data-original="assets/images/products/deals/product-1-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                        <img data-original="assets/images/products/deals/product-1-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner with-bottom-padding">
                                                <div class="product-image">
                                                    <div class="label-product label-sale">-64%</div>
                                                    <a href="single-product.html">
                                                        <img data-original="assets/images/products/deals/product-2-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                        <img data-original="assets/images/products/deals/product-2-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner with-bottom-padding">
                                                <div class="product-image">
                                                    <div class="label-product label-sale">-44%</div>
                                                    <a href="single-product.html">
                                                        <img data-original="assets/images/products/deals/product-3-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                        <img data-original="assets/images/products/deals/product-3-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner with-bottom-padding">
                                                <div class="product-image">
                                                    ...
                                                    <a href="single-product.html">
                                                        <img data-original="assets/images/products/deals/product-4-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner with-bottom-padding">
                                                <div class="product-image">
                                                    <div class="label-product label-sale">-53%</div>
                                                    <a href="single-product.html">
                                                        <img data-original="assets/images/products/deals/product-1-1.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                        <img data-original="assets/images/products/deals/product-1-2.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-cart"></i></a>
                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                            ...
                            <div class="row">
                                <div class="col-7 col-sm-7 col-md-8 col-lg-8">
                                    ...
                                    <div class="product-carousel-wrapper pos-r">
                                        <div class="product-carousel" data-visible-slide="2" data-visible-lg-slide="2" data-visible-md-slide="2" data-visible-sm-slide="1" data-loop="true" data-speed="1000" data-space-between="20">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-1-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-1-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-2-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-2-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-3-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-3-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-4-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-4-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-5-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-5-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-6-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-6-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-7-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-7-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-8-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-8-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-9-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                                                    ...
                                                    <div class="product-list-single">
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mr-3 mr-sm-3 mr-md-2 mr-xl-3">
                                                                    <a href="single-product.html">
                                                                        <img data-original="assets/images/products/featured/products-10-2.jpg" alt="Proin Lectus Ipsum" class="hover-image">
                                                                        <img data-original="assets/images/products/featured/products-10-1.jpg" alt="Proin Lectus Ipsum" title="Proin Lectus Ipsum">
                                                                    </a>
                                                                </div> <!-- end of product-image -->
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12">
                                    <div class="promo-banner hover-effect-2 mt-half">
                                        <a href="#">
                                            <img data-original="assets/images/banners/banner-6.jpg" alt="Promo Banner">
                                        </a>
                                    </div>
                                </div>
                            </div><!-- end of row -->
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="testimonial-media" data-swiper-parallax="-100">
                                                        <img data-original="assets/images/testimonial/testimonial-1.jpg" alt="Alva Ono">
                                                    </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="testimonial-media" data-swiper-parallax="-100">
                                                        <img data-original="assets/images/testimonial/testimonial-2.jpg" alt="Dewey Tetzlaff">
                                                    </div>
                                                    <div class="testimonial-content" data-swiper-parallax="-500">
                                                        <p>All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you!</p>
                                                        <div class="client-meta" data-swiper-parallax="-300">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="testimonial-media" data-swiper-parallax="-100">
                                                        <img data-original="assets/images/testimonial/testimonial-3.jpg" alt="Amber Laha">
                                                    </div>
                                                    <div class="testimonial-content" data-swiper-parallax="-500">
                                                        <p>All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you!</p>
                                                        <div class="client-meta" data-swiper-parallax="-300">
                            ...
                            <div class="client-carousel">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-1.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-2.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-3.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-4.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-5.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-6.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-7.jpg" alt="Client Logo">
                                    </div>
                                    <div class="item-brand swiper-slide">
                                        <img data-original="assets/images/brand/client-logo-8.jpg" alt="Client Logo">
                                    </div>
                                </div>
